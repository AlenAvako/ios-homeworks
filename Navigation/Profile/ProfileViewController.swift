...
//        Mark: Profile image
        ...
        profileView.profileImage.frame = CGRect(origin: CGPoint(x: 16,
                                                                y: 16),
                                                size: CGSize(width: view.frame.width / 3.2,
        ...
        profileView.getStatusButton.frame = .init(x: 16,
                                                  y: profileView.profileImage.frame.maxY + 44,
...
//        Mark: Name Label
        ...
        profileView.nameLabel.frame = CGRect(origin: CGPoint(x: profileView.profileImage.bounds.width + 32,
                                                             y: 27.0),
                                             size: CGSize(width: view.frame.width - profileView.profileImage.frame.width - 48,
                                                          height: 18))
...
//        Mark: Status Label
        ...
        profileView.statusLabel.frame = CGRect(x: profileView.profileImage.bounds.width + 32,
                                               y: profileView.getStatusButton.frame.minY - 74,
                                               width: view.frame.width - profileView.profileImage.frame.width - 48,
                                               height: 14)
        ...
        profileView.addStatus.frame = CGRect(x: profileView.profileImage.frame.width + 32,
                                             y: profileView.statusLabel.frame.maxY + 10,
                                             width: view.frame.width - profileView.profileImage.frame.width - 48,
                                             height: 40)
    ...
    @objc func getStatus() {
        ...
        print(profileHV.statusLabel.frame.maxY)
        print(profileHV.statusLabel.frame.minY)
        print(profileHV.getStatusButton.frame.minY)
    }
